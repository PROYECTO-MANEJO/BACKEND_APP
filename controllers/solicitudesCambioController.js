...
const actualizarSolicitudMaster = async (req, res) => {
  try {
    ...
    if (plan_backout_sol !== undefined) {
      datosActualizacion.plan_backout_sol = plan_backout_sol;
    }
    if (plan_testing_sol !== undefined) {
      datosActualizacion.plan_testing_sol = plan_testing_sol;
    }
