...
exports.AssignDeveloperUseCase = void 0;
class AssignDeveloperUseCase {
    constructor(changeRequestRepository, developerRepository, workflowService) {
    ...
    async execute(data) {
        ...
        changeRequest.startDevelopment(data.developerId, developer.getUserId(), // nombre del desarrollador
...
exports.AssignDeveloperUseCase = AssignDeveloperUseCase;
//# sourceMappingURL=AssignDeveloperUseCase.js.map