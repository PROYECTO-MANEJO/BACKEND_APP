...
exports.GetMyChangeRequestsUseCase = void 0;
class GetMyChangeRequestsUseCase {
    ...
    async execute(data) {
        ...
        const result = await this.changeRequestRepository.findByRequesterId(data.userId, filters);
        // Calcular páginas
    ...
    validateInput(data) {
        ...
        if (data.changeType) {
            ...
            if (!validTypes.includes(data.changeType)) {
                throw new Error(`Tipo de cambio inválido. Valores válidos: ${validTypes.join(", ")}`);
            }
        }
    }
}
exports.GetMyChangeRequestsUseCase = GetMyChangeRequestsUseCase;
//# sourceMappingURL=GetMyChangeRequestsUseCase.js.map