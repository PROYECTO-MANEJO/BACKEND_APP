...
exports.UpdateCourseCareerIdsUseCase = void 0;
class UpdateCourseCareerIdsUseCase {
    ...
    async execute(request) {
        try {
            ...
            const updatedCourse = await this.courseManagementService.updateCourseCarerIds(request.courseId, request.careerIds, request.organizerId);
            return {
                success: true,
...
exports.UpdateCourseCareerIdsUseCase = UpdateCourseCareerIdsUseCase;
//# sourceMappingURL=UpdateCourseCareerIdsUseCase.js.map