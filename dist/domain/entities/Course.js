...
class Course {
    ...
    get nom_cur() { return this._nom_cur; }
    get des_cur() { return this._des_cur; }
    get dur_cur() { return this._dur_cur; }
    get fec_ini_cur() { return this._fec_ini_cur; }
    get fec_fin_cur() { return this._fec_fin_cur; }
    get id_cat_cur() { return this._id_cat_cur; }
    get ced_org_cur() { return this._ced_org_cur; }
    get capacidad_max_cur() { return this._capacidad_max_cur; }
    get tipo_audiencia_cur() { return this._tipo_audiencia_cur; }
    get requiere_verificacion_docs() { return this._requiere_verificacion_docs; }
    get es_gratuito() { return this._es_gratuito; }
    get precio() { return this._precio || null; }
    get porcentaje_asistencia_aprobacion() { return this._porcentaje_asistencia_aprobacion; }
    get nota_minima_aprobacion() { return this._nota_minima_aprobacion; }
    get estado_cur() { return this._estado_cur; }
    get fecha_creacion() { return this._fecha_creacion; }
    get fecha_actualizacion() { return this._fecha_actualizacion; }
