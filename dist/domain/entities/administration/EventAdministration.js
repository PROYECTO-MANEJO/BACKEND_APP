...
exports.EventAdministration = void 0;
class EventAdministration {
    constructor(data) {
        this.data = data;
        this.validateData();
    }
    static create(eventId, eventName, startDate, endDate, maxCapacity, categoryId, categoryName, organizerId, organizerName, eventCost = 0, eventDescription) {
        const now = new Date();
        const adminData = {
    ...
    static fromPrismaData(eventData) {
        const inscriptions = eventData.inscripciones?.map((ins) => ({
    ...
    approveInscription(inscriptionId) {
        ...
        const updatedInscriptions = this.data.inscriptions.map((ins) => ins.id === inscriptionId
            ...
            : ins);
        const updatedStatistics = EventAdministration.calculateStatistics(updatedInscriptions, this.data.maxCapacity);
        const updatedData = {
            ...this.data,
    ...
    updateCapacity(newMaxCapacity) {
        ...
        const updatedStatistics = EventAdministration.calculateStatistics(this.data.inscriptions, newMaxCapacity);
        const updatedData = {
            ...this.data,
...
exports.EventAdministration = EventAdministration;
//# sourceMappingURL=EventAdministration.js.map