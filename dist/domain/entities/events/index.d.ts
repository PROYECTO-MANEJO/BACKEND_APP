 ...
 */
export { Event, type EventArea, type EventAudience, type EventStatus, type EventSchedule, type EventLocation, type EventPricing, type EventRequirements, type EventRegistration, type EventMaterials, type EventFeedback, type EventData, } from "./Event";
export { EventCategory, type EventCategoryStatistics, type EventCategorySettings, type EventCategoryData, } from "./EventCategory";
...
export declare class EventValidation {
...
export declare class EventStatusTransitions {
    private static readonly VALID_TRANSITIONS;
    static canTransitionTo(currentStatus: "ACTIVO" | "INACTIVO" | "CANCELADO" | "COMPLETADO" | "EN_PROCESO", newStatus: "ACTIVO" | "INACTIVO" | "CANCELADO" | "COMPLETADO" | "EN_PROCESO"): boolean;
    static getValidTransitions(currentStatus: "ACTIVO" | "INACTIVO" | "CANCELADO" | "COMPLETADO" | "EN_PROCESO"): ("ACTIVO" | "INACTIVO" | "CANCELADO" | "COMPLETADO" | "EN_PROCESO")[];
}
...
export declare class EventCapacityError extends EventError {
    constructor(message: string, details?: any);
}
export declare class EventSchedulingError extends EventError {
    constructor(message: string, details?: any);
}
export declare class CategoryError extends EventError {
    constructor(message: string, details?: any);
}
