 ...
 */
import { ChangeRequest, ChangeRequestStatus, Priority } from "../entities/ChangeRequest";
export interface ChangeRequestRepository {
     ...
     */
    findByCreationDateRange(startDate: Date, endDate: Date): Promise<ChangeRequest[]>;
    /**
     ...
     */
    findInactiveAssignedRequests(daysSinceLastUpdate: number): Promise<ChangeRequest[]>;
    /**
     * Busca solicitudes por complejidad estimada
     */
    findByEstimatedHours(minHours?: number, maxHours?: number): Promise<ChangeRequest[]>;
    /**
     ...
     */
    getStatusHistory(changeRequestId: string): Promise<Array<{
...
//# sourceMappingURL=ChangeRequestRepository.d.ts.map