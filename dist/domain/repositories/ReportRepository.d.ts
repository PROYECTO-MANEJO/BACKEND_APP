 ...
 */
import { Report, ReportType, ReportFormat, ReportStatus } from "../entities/Report";
export interface ReportRepository {
     ...
     */
    logAccess(reportId: string, userId: string, accessType: "VIEW" | "DOWNLOAD"): Promise<void>;
    /**
     * Obtiene historial de accesos del reporte
     */
    getAccessHistory(reportId: string): Promise<Array<{
        userId: string;
     ...
     */
    findSimilarReports(type: ReportType, filters: Record<string, any>, excludeId?: string): Promise<Report[]>;
    /**
