...
export interface GitHubIntegrationService {
     ...
     */
    updateIssue(issueNumber: number, updates: {
        title?: string;
        body?: string;
        state?: "open" | "closed";
        labels?: string[];
     ...
     */
    createPullRequest(request: CreatePullRequestRequest): Promise<GitHubPullRequest>;
    /**
     ...
     */
    updatePullRequest(prNumber: number, updates: {
        title?: string;
        body?: string;
        state?: "open" | "closed";
     ...
     */
    getPullRequestChecks(prNumber: number): Promise<Array<{
        name: string;
     ...
     */
    configureWebhook(events: string[], callbackUrl: string): Promise<{
        id: number;
        url: string;
        events: string[];
    }>;
...
//# sourceMappingURL=GitHubIntegrationService.d.ts.map