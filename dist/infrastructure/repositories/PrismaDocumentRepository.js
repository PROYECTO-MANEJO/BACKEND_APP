...
class PrismaDocumentRepository {
     ...
     */
    async uploadCedulaDocument(userId, documentData) {
        try {
     ...
     */
    async uploadMatriculaDocument(userId, documentData) {
        try {
            await this.prisma.usuario.update({
                where: { id_usu: userId },
                data: {
     ...
     */
    async getCedulaDocument(userId) {
        try {
     ...
     */
    async getMatriculaDocument(userId) {
        try {
            const user = await this.prisma.usuario.findUnique({
                where: { id_usu: userId },
                select: {
     ...
     */
    async approveCedulaDocument(userId, approvedBy) {
        try {
            await this.prisma.usuario.update({
                where: { id_usu: userId },
                data: {
     ...
     */
    async approveMatriculaDocument(userId, approvedBy) {
        try {
            await this.prisma.usuario.update({
                where: { id_usu: userId },
                data: {
     ...
     */
    async rejectCedulaDocument(userId, rejectedBy, reason) {
        try {
            await this.prisma.usuario.update({
                where: { id_usu: userId },
                data: {
     ...
     */
    async rejectMatriculaDocument(userId, rejectedBy, reason) {
        try {
            await this.prisma.usuario.update({
                where: { id_usu: userId },
                data: {
     ...
     */
    async hasAllDocumentsApproved(userId) {
        try {
            const user = await this.prisma.usuario.findUnique({
                where: { id_usu: userId },
                select: {
    ...
    async getDocumentStats() {
        try {
            const [totalUsers, usersWithDocuments, usersWithAllApproved, pendingCedula, pendingMatricula, totalUploaded, totalApproved,] = await Promise.all([
     ...
     */
    async markDocumentsAsVerified(userId) {
        try {
            await this.prisma.usuario.update({
                where: { id_usu: userId },
                data: {
