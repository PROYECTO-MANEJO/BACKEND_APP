...
class CareerController extends BaseController_1.BaseController {
    ...
    async getCareerStats(req, res) {
        try {
            ...
            const [totalUsuarios, totalEventos, totalCursos, eventosActivos, cursosActivos] = await Promise.all([
