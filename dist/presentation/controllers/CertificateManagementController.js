...
class CertificateManagementController extends BaseController_1.BaseController {
     ...
     */
    async getEventApprovedParticipants(req, res) {
        try {
     ...
     */
    async getCourseApprovedParticipants(req, res) {
        try {
     ...
     */
    async generateMassiveEventCertificates(req, res) {
        try {
     ...
     */
    async generateMassiveCourseCertificates(req, res) {
        try {
    ...
    async getCertificateStats(req, res) {
        try {
            const prisma = this.container.getPrismaClient();
            const [eventCertificateStats, courseCertificateStats] = await Promise.all([
     ...
     */
    async generateEventCertificatePDF(evento, participacion) {
     ...
     */
    async generateCourseCertificatePDF(curso, participacion) {
        return new Promise((resolve, reject) => {
            try {
                const doc = new pdfkit_1.default({
                    size: 'A4',
...
//# sourceMappingURL=CertificateManagementController.js.map