...
exports.DocumentVerificationController = void 0;
const BaseController_1 = require("./BaseController");
class DocumentVerificationController extends BaseController_1.BaseController {
     ...
     */
    async downloadUserDocument(req, res) {
        try {
     ...
     */
    async approveUserDocument(req, res) {
        try {
            const { userId, documentType } = req.params;
            const prisma = this.container.getPrismaClient();
            // Validar que los parámetros existan
    ...
    async getDocumentStats(req, res) {
        try {
            const prisma = this.container.getPrismaClient();
            const [totalConDocumentos, documentosAprobados, documentosRecientes] = await Promise.all([
...
exports.DocumentVerificationController = DocumentVerificationController;
