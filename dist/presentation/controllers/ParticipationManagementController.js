...
exports.ParticipationManagementController = void 0;
const BaseController_1 = require("./BaseController");
class ParticipationManagementController extends BaseController_1.BaseController {
     ...
     */
    async getEventInscriptionsForParticipation(req, res) {
        try {
     ...
     */
    async getCourseInscriptionsForParticipation(req, res) {
        try {
     ...
     */
    async registerEventParticipation(req, res) {
        try {
            const { eventId } = req.params;
     ...
     */
    async registerCourseParticipation(req, res) {
        try {
            const { courseId } = req.params;
    ...
    async getEventParticipationStats(req, res) {
        try {
            const { eventId } = req.params;
            const prisma = this.container.getPrismaClient();
            const [totalInscritos, totalParticipaciones, aprobados, promedioAsistencia, evento] = await Promise.all([
     ...
     */
    async getCourseParticipationStats(req, res) {
        try {
            const { courseId } = req.params;
            const prisma = this.container.getPrismaClient();
            const [totalInscritos, totalParticipaciones, aprobados, promedios, curso] = await Promise.all([
     ...
     */
    async getGeneralParticipationStats(req, res) {
        try {
            const prisma = this.container.getPrismaClient();
            const [eventStats, courseStats] = await Promise.all([
...
exports.ParticipationManagementController = ParticipationManagementController;
//# sourceMappingURL=ParticipationManagementController.js.map