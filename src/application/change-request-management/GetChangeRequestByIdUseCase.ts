...
export class GetChangeRequestByIdUseCase {
  ...
  public async execute(requestId: string, userId?: string): Promise<ChangeRequest | null> {
  ...
  private canUserAccessRequest(changeRequest: ChangeRequest, userId: string): boolean {
