...
export class Course {
  ...
  constructor(data: CourseData) {
    ...
    this._porcentaje_asistencia_aprobacion = data.porcentaje_asistencia_aprobacion;
  ...
  private validateDuration(duracion: number): void {
    ...
    if (duracion > 2000) { // Aproximadamente 1 año de 40 horas semanales
  ...
  private validateApprovalCriteria(porcentajeAsistencia: number, notaMinima: number): void {
  ...
  private validatePrice(esGratuito: boolean, precio?: number | null): void {
    if (!esGratuito) {
      ...
      if (precio > 10000000) { // Precio máximo razonable
  ...
  private validateAudienceType(tipoAudiencia: string): void {
    const tiposValidos = ['CARRERA_ESPECIFICA', 'TODAS_CARRERAS', 'PUBLICO_GENERAL'];
  ...
  public isInProgress(): boolean {
    const now = new Date();
    return this._fec_ini_cur <= now && this._fec_fin_cur >= now && this._estado_cur === 'ACTIVO';
  }
  ...
  get nom_cur(): string { return this._nom_cur; }
  get des_cur(): string { return this._des_cur; }
  get dur_cur(): number { return this._dur_cur; }
  get fec_ini_cur(): Date { return this._fec_ini_cur; }
  get fec_fin_cur(): Date { return this._fec_fin_cur; }
  get id_cat_cur(): number { return this._id_cat_cur; }
  get ced_org_cur(): string { return this._ced_org_cur; }
  get capacidad_max_cur(): number { return this._capacidad_max_cur; }
  get tipo_audiencia_cur(): string { return this._tipo_audiencia_cur; }
  get requiere_verificacion_docs(): boolean { return this._requiere_verificacion_docs; }
  get es_gratuito(): boolean { return this._es_gratuito; }
  get precio(): number | null { return this._precio || null; }
  get porcentaje_asistencia_aprobacion(): number { return this._porcentaje_asistencia_aprobacion; }
  get nota_minima_aprobacion(): number { return this._nota_minima_aprobacion; }
  get estado_cur(): string { return this._estado_cur; }
  get fecha_creacion(): Date | undefined { return this._fecha_creacion; }
  get fecha_actualizacion(): Date | undefined { return this._fecha_actualizacion; }
