...
export interface IReportRepository {
   ...
   */
  generateEventParticipationReport(
    eventId: string
   ...
   */
  generateCourseParticipationReport(
    courseId: string
...
// Interfaces de apoyo para los reportes
