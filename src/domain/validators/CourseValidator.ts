...
export class CourseValidator {
   ...
   */
  public static validate(data: CourseData): void {
   ...
   */
  private static validateRequiredFields(data: CourseData): void {
   ...
   */
  private static validateDates(fechaInicio: Date, fechaFin: Date): void {
    const now = new Date();
   ...
   */
  private static validateAudienceType(tipoAudiencia: string): void {
    const tiposValidos = [
      "CARRERA_ESPECIFICA",
      "TODAS_CARRERAS",
      "PUBLICO_GENERAL",
   ...
   */
  public static validateDurationValue(duration: number | undefined): void {
