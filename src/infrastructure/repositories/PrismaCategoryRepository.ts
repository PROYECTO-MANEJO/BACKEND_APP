...
export class PrismaCategoryRepository implements ICategoryRepository {
   ...
   */
  async findWithFilters(filters: CategoryFilters): Promise<Category[]> {
    try {
   ...
   */
  async countRelatedItems(id: string): Promise<CategoryRelationsCount> {
    try {
   ...
   */
  private mapPrismaToEntity(prismaCategory: any): Category {
    return {
