...
export class ChangeRequestController extends BaseController {
   ...
   */
  public async getDevelopers(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const prisma = this.container.getPrismaClient();
   ...
   */
  public async getAdminStatistics(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const prisma = this.container.getPrismaClient();
   ...
   */
  public async approveChangeRequest(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const { id } = req.params;
   ...
   */
  public async rejectChangeRequest(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const { id } = req.params;
   ...
   */
  public async updateChangeRequestMaster(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const { id } = req.params;
      const {
        impacto_negocio_sol,
