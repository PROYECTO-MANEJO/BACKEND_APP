...
export class DeveloperController extends BaseController {
   ...
   */
  public async getAllDevelopers(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  public async getAssignedRequests(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  public async updateRequestStatus(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
   ...
   */
  public async getWorkloadStats(req: AuthenticatedRequest, res: Response): Promise<void> {
    try {
      const userRole = req.usuario?.rol;
